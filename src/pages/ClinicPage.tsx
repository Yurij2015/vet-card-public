      ...
      <div className="hidden lg:block">
        ...
        <main className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-12">
            <button
              onClick={callClinic}
              className="flex items-center gap-3 bg-white px-6 py-4 rounded-xl shadow-sm hover:shadow-md transition-shadow"
            >
              ...
              <span className="text-lg font-medium text-gray-900">{clinicInfo.phone || '(316) 555-0123'}</span>
            </button>
            ...
            {clinicInfo.email && (
              ...
              >
                ...
                <span className="text-lg font-medium text-gray-900">{clinicInfo.email}</span>
              </button>
            )}
            ...
            {clinicInfo.address && (
              ...
              >
                ...
                <span className="text-lg font-medium text-gray-900">{clinicInfo.address}</span>
              </button>
            )}
          </div>
              ...
              <ul className="space-y-2">
                {displayServices.map((service) => (
                  <li key={service.id} className="flex items-start gap-3 text-gray-700">
                    <PetsIcon color={themeColor} className="w-5 h-5 mt-0.5 flex-shrink-0" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {clinicInfo.gallery.slice(0, 4).map((photo, index) => (
                  <div key={photo.id || index} className="aspect-square overflow-hidden rounded-xl bg-gray-100">
                    <img src={photo.url} alt={photo.title || 'Gallery'} className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
            </div>
